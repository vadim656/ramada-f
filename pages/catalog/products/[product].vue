<template>
  <div class="container mx-auto relative">
    <div class="flex flex-col gap-24" v-if="data">
      ...
      <section class="w-full flex flex-col gap-10">
        <div class="flex items-center gap-6 text-neutral-600 text-sm">
          <nuxt-link to="/"
            ><img src="~/assets/img/logo-neutral.svg" alt="" class="opacity-50"
          /></nuxt-link>
        ...
        <div class="flex items-start justify-between gap-4">
          <div class="flex items-start gap-4">
            <h1 class="text-6xl">{{ data.product.data.attributes.Name }} - {{ data.product.data.attributes.Characteristic.Razmer }}</h1>
            
          </div>
          <span>Артикул: {{ data.product.data.attributes.Art }}</span>
        </div>
      </section>
      <!-- head -->
      <section class="w-full grid grid-cols-[7fr,5fr] gap-10">
        <!-- slider -->
        <div class="flex flex-col gap-10">
          <img
            :src="
              runtimeConfig.apiBase +
                data.product.data.attributes.Img.data[0].attributes.url
            "
            alt=""
          />
        ...
        <div class="flex flex-col gap-10">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col divide-y divide-neutral-200">
              <div class="flex justify-between items-center w-full py-2">
                ...
                <span>
                  {{
                    data.product.data.attributes.Characteristic.Proizvidotel
                  }}</span
                >
              </div>
              <div class="flex justify-between items-center w-full py-2">
                <span>Ширина:</span>
                <span>
                  {{ data.product.data.attributes.Characteristic.Kolvo }}</span
                >
              </div>
              <div class="flex justify-between items-center w-full py-2">
                <span>Высота:</span>
                <span>
                  {{ data.product.data.attributes.Characteristic.Razmer }}</span
                >
              </div>
            </div>
          </div>
          <div class="flex flex-col gap-4 py-2">
            <div class="flex flex-col gap-2">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-2">
                <div class="flex flex-col gap-1 items-start p-2  bg-neutral-100 rounded-md ">
                  <img src="~/assets/img/photo/test-materials.jpg" alt="">
                  <span class="text-xs">Дерево</span>
                </div>
                <div class="flex flex-col gap-1 items-start p-2 bg-neutral-700 text-white rounded-md">
                  <img src="~/assets/img/photo/test-materials.jpg" class="rounded-md" alt="">
                  <span class="text-xs">Красный</span>
                </div>
                <div class="flex flex-col gap-1 items-start p-2 bg-neutral-100 rounded-md">
                  <img src="~/assets/img/photo/test-materials.jpg" class="rounded-md" alt="">
          ...
          <div class="flex flex-col gap-4 py-2">
            <div class="flex flex-col gap-2">
              <span class="font-semibold text-lg">Цвет металла</span>
              <div class="grid grid-cols-6 gap-2 flex-row">
                <div class="flex flex-col gap-1 items-start p-2 bg-neutral-700 text-white rounded-md">
                  <img src="~/assets/img/photo/test-materials.jpg" class="rounded-md" alt="">
                  <span class="text-xs">Дерево</span>
                </div>
          ...
          <div class="flex flex-col gap-10 py-4">
            ...
            <div class="flex flex-col gap-2">
              ...
              <span>наличный, безналичный расчёт, онлайн оплата</span>
            </div>
          </div>
      ...
      <section class=" w-full flex flex-col gap-4">
        <headersHH3>Другие беседки</headersHH3>
