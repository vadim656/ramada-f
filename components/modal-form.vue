  ...
  <Transition name="slide-fade">
    ...
    >
      ...
      <div class=" z-[101] absolute">
        <div
          class="bg-white p-6  relative flex flex-col gap-4 rounded-md drop-shadow-2xl w-full max-w-[420px]"
        >
            ...
            <div class="flex items-center justify-between w-full gap-6">
              <span class="text-2xl"
                ...
                <nuxt-link
                  ...
                  class="underline underline-offset-4 text-xl"
                  >{{ data.attributes.Name }}</nuxt-link
                >
              </span>
